...
| H-11 | Preserve compatibility until explicit protocol reconciliation is reviewed and tested | AIT wraps native output without reinterpreting it; target-envelope completeness is locked by executable fixtures, Code Slice has an explicit native profile, and other native profiles remain explicit |
