...
| H-11 | Preserve compatibility until explicit protocol reconciliation is reviewed and tested | AIT wraps native output without reinterpreting it; target-envelope completeness is locked by executable fixtures, Code Slice, Project Profile, and Change Impact have explicit native profiles, and other native profiles remain explicit |
