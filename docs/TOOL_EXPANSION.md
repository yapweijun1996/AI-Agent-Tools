...
| EXP-06 | Public repository `AI-Agent-Tool-CFML-Check`; current public commit and clean-clone audit recorded in [VALIDATION](../VALIDATION.md); `npm ci`, typecheck and 22/22 tests passed | CFML Check bounded implementation and declared CLI/capability contract are exercised; engine compatibility, npm publication and CF-14 remain unverified |
